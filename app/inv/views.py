...
class CategoriaNew(SuccessMessageMixin, SinPrivilegios, generic.CreateView):
    ...
    def form_valid(self, form):
        form.instance.uc = self.request.user  # self.request.user es el usuario (usuario creado) que esta logueado
...
class ProductoEdit(SuccessMessageMixin, SinPrivilegios, generic.UpdateView):
    ...
    form_class = ProductoForm
    success_url = reverse_lazy("inv:producto_list")
    susccess_message = "Producto Actualizado Satisfactoriamente"
